const QUESTION_BANK = [
  {
    ...
    "options": [
      ...
      "Ground Frequency Current Insulator",
  ...
  },
  {
    ...
    "options": [
      ...
      "PPE rated for the voltage level",
      "Cotton gloves",
      "Any insulated gloves"
    ],
    "answer": 1
  },
  {
  ...
  },
  {
    "id": 9,
    "topic": "Ohm's Law",
    "question": "Three resistors of 4+�, 6+�, and 12+� are connected in parallel. What is the total resistance?",
    "options": [
      "22 +�",
      "2 +�",
      "8 +�",
  ...
  },
  {
    "id": 10,
    "topic": "Ohm's Law",
    "question": "In a series circuit with R1=10+� and R2=20+� at 90V, what is the voltage drop across R1?",
    "options": [
      "45 V",
      "60 V",
      "30 V",
  ...
  },
  {
    ...
    "options": [
      "Neutral Metal-Base",
      "Non-Metallic sheathed cable rated 90-�C",
      "Normal Metal-Bonded",
      "Non-Magnetic Base"
    ],
    "answer": 1
  ...
  },
  {
    ...
    "options": [
      "Replace the breaker",
      "Identify and fix the cause of overload/fault",
      "Reset and ignore it",
      "Add another circuit"
    ],
    "answer": 1
  },
  {
    ...
    "options": [
      "Carry fault current to ground",
      "Complete the circuit by returning current to the source",
      "Prevent voltage surges",
      "Provide an alternate hot path"
    ],
    "answer": 1
  },
  {
  ...
  },
  {
    ...
    "options": [
      "Lowest range",
      "Highest range",
      "Auto range if available, else highest",
      "Resistance mode"
    ],
    "answer": 2
  },
  ...
  },
  {
    ...
    "options": [
      ...
      "Detecting the electric field without touching conductors",
      "Completing a test circuit",
  ...
  },
  {
    ...
    "options": [
      ...
      "National Engineering Codebook",
      "North American Electrical Code",
      "National Energy Compliance"
    ],
    "answer": 0
  },
  {
    ...
    "options": [
      "Bathrooms only",
      "All kitchen circuits",
      "Most bedroom and living area circuits",
  ...
  },
  {
    ...
    "options": [
      "No specific requirement as long as accessible",
      "Exactly 12 inches",
      "No more than 5.5 feet",
      "At least 18 inches"
    ],
    "answer": 0
  },
  ...
  },
  {
    "id": 35,
    "topic": "AC Theory",
    "question": "What is the impedance of a circuit with R=3+� and XL=4+�?",
    "options": [
      "7 +�",
      "1 +�",
      "5 +�",
  ...
  },
  {
    ...
    "options": [
      "Open main winding",
      "Failed start capacitor or start winding",
      "Overvoltage",
  ...
  },
  {
    ...
    "options": [
      "Fuse rating is 10A",
      "Full Load Amperes is 10A",
      "Frequency Lock Amperes is 10A",
      "Fault Level Amps is 10A"
    ],
    "answer": 1
  },
  {
    ...
    "options": [
      "Swap any two of the three phase leads",
      "Swap all three phase leads",
      "Reverse the ground wire",
      "Change the capacitor polarity"
    ],
    "answer": 0
  },
  {
    ...
    "options": [
      ...
      "Full Load Amperes (FLA) +� a code-allowed percentage",
      "Breaker size only",
      "Voltage rating"
    ],
    "answer": 1
  ...
  },
  {
    ...
    "options": [
      ...
      "Enclosed Metallic Tray",
      "External Metal Tube",
      "Electrical Metallic Threaded"
    ],
    "answer": 0
  },
  {
  ...
  },
  {
    ...
    "options": [
      "Never",
      "Only if it's galvanized",
      "Yes, when properly installed with listed fittings",
  ...
  },
  {
    "id": 45,
    "topic": "Conduit & Raceway",
    "question": "Where exposed to physical damage without protection",
    "options": [
      "PVC conduit should NOT be used:",
      "Underground",
      "In concealed walls",
      "In wet locations"
    ],
  ...
  },
  {
    ...
    "options": [
      "Provide a neutral return path",
      "Limit fault current magnitude",
      "Provide a low-impedance path for fault current to operate overcurrent protection",
      "Prevent static buildup only"
    ],
    "answer": 2
  },
  {
    ...
    "options": [
      ...
      "Ensure electrical continuity between metal parts",
      "Increase ampacity",
      "Reduce voltage drop"
    ],
    "answer": 1
  },
  {
    ...
    "options": [
      "Panel to earth",
      "Neutral bus to equipment grounding bus at the service",
      "Two separate panels",
      "Ground rod to water pipe"
    ],
    "answer": 1
  },
  {
